...
class XmasLight:
    ...
    def __init__(self, sign, x, y, color=None, period=None, minbright=None):
        ...
        if self.color is None:
            if XmasLight.lastcolor is None:
        ...
        if now < santastart or (now.month == 12 and now.day > 25):
            ...
            if int(seconds / 15) % 5 == 0:
                if now.month == 12 and now.day > 25:
                    ...
                    graphics.DrawText(sign.canvas, sign.font46, 52, 24, graphics.Color(160, 160, 20), "Elf Holiday!")
                else:
            ...
            if int(deltasec / 15) % 5 == 0:  # or deltasec<santapath_times[1]:
                ...
                if gift is None and random.random() < 0.05 and code != "NORTH" and code != "OCEAN":
