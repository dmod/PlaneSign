...
class Fish:
    ...
    def swim(self):
        ...
        # change direction
        if (
            ((self.dir == 1 or self.dir == 3) and random.random() < self.turnprob)
            or ((self.dir == 0 or self.dir == 2) and random.random() < 0.5)
            or (self.dir == 0 and self.z == tankzmax)
            or (self.dir == 2 and self.z == tankzmin)
            or (self.dir == 3 and self.x == tankxmin)
            or (self.dir == 1 and self.x == tankxmax - self.width)
        ):
