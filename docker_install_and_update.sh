...
sudo docker create --restart unless-stopped --name PlaneSignRuntime --privileged -p 80:80 -p 443:443 --mount type=bind,source="$INSTALL_DIR/sign.conf",target=/planesign/sign.conf ghcr.io/dmod/planesign:latest
